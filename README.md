...
Das System ist insgesamt sehr minimalistisch nur mit den Basispaketen ausgestattet, die zwingend benötigt werden und jedes Programm, was auf dem System läuft, wurde vorher auch auf dem System selbst kompiliert, wodurch einige Programme und Bibliotheken besser an das spezifische System angepasst sind. Eine Liste aller installierten Programme findet sich [hier](https://github.com/maxicraftone/linux-from-scratch/blob/main/sources.list).
